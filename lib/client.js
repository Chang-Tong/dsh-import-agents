...
var __dshImportClientFactory = (() => {
  ...
  function labels() {
    return isChineseUi() ? { idle: "\u540C\u6B65", busy: "\u540C\u6B65\u4E2D\u2026", title: "\u540C\u6B65 pi / opencode \u7684\u5386\u53F2\u4F1A\u8BDD\u3001agents\u3001skills\uFF08/import-all\uFF09" } : { idle: "Sync", busy: "Syncing\u2026", title: "Sync pi / opencode sessions, agents and skills (/import-all)" };
  }
