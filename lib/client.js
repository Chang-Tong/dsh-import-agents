...
var __dshImportClientFactory = (() => {
  ...
  function labels() {
    return isChineseUi() ? { idle: "\u540C\u6B65", busy: "\u540C\u6B65\u4E2D\u2026", failed: "\u540C\u6B65\u5931\u8D25", title: "\u540C\u6B65 pi / opencode \u7684\u5386\u53F2\u4F1A\u8BDD\u3001agents\u3001skills\uFF08/import-all\uFF09" } : { idle: "Sync", busy: "Syncing\u2026", failed: "Sync failed", title: "Sync pi / opencode sessions, agents and skills (/import-all)" };
  }
  function SyncButton({ sync, resultHideMs = RESULT_HIDE_MS }) {
    ...
    const onClick = async () => {
      ...
      try {
        ...
        setResult(outcome);
        scheduleClear(timer, () => setResult(void 0), resultHideMs);
      } catch (error) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: "6px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          disabled: busy,
          children: busy ? labels().busy : labels().idle
        }
      ),
